...
#SBATCH --job-name=rand_lsqr
#SBATCH --output=rand_lsqr_%j.out
#SBATCH --error=rand_lsqr_%j.err
...
matlab -r 'cd /home/jyliu/NUFFT2D; nufft2d_startup; cd experiments/typeII_2d_rand_lsqr; exp_typeII_2d_rand_lsqr;'
