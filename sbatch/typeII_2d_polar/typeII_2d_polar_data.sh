...
#SBATCH --job-name=polar_data
#SBATCH --output=polar_data_%j.out
#SBATCH --error=polar_data_%j.err
...
matlab -r 'cd /home/jyliu/NUFFT2D; nufft2d_startup; cd experiments/typeII_2d_polar; exp_typeII_2d_polar_data;'
