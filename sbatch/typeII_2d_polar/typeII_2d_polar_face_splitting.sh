...
#SBATCH --job-name=polar_face_splitting
#SBATCH --output=polar_face_splitting_%j.out
#SBATCH --error=polar_face_splitting_%j.err
...
matlab -r 'cd /home/jyliu/NUFFT2D; nufft2d_startup; cd experiments/typeII_2d_polar; exp_typeII_2d_polar_face_splitting;'
