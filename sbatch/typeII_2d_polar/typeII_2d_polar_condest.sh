...
#SBATCH --job-name=polar_condest
#SBATCH --output=polar_condest_%j.out
#SBATCH --error=polar_condest_%j.err
...
matlab -r 'cd /home/jyliu/NUFFT2D; nufft2d_startup; cd experiments/typeII_2d_polar; exp_typeII_2d_polar_condest;'
