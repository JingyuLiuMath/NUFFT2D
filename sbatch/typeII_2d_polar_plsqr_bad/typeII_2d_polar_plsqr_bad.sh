...
#SBATCH --job-name=polar_plsqr_bad
#SBATCH --output=polar_plsqr_bad_%j.out
...
matlab -r 'cd /home/jyliu/NUFFT2D; nufft2d_startup; cd experiments/typeII_2d_polar_plsqr_bad; exp_typeII_2d_polar_plsqr_bad;'
