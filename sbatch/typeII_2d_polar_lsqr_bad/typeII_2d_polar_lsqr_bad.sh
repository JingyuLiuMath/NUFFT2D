...
#SBATCH --job-name=polar_lsqr_bad
#SBATCH --output=polar_lsqr_bad_%j.out
#SBATCH --error=polar_lsqr_bad_%j.err
...
matlab -r 'cd /home/jyliu/NUFFT2D; nufft2d_startup; cd experiments/typeII_2d_polar_lsqr_bad; exp_typeII_2d_polar_lsqr_bad;'
