...
#SBATCH --job-name=rand_condest
#SBATCH --output=rand_condest_%j.out
#SBATCH --error=rand_condest_%j.err
...
matlab -r 'cd /home/jyliu/NUFFT2D; nufft2d_startup; cd experiments/typeII_2d_rand; exp_typeII_2d_rand_condest;'
