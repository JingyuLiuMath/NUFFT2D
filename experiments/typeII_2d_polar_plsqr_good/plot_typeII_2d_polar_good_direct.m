...
set(gca, 'FontSize', 18);
saveas(gcf, "./figure/polar_good_hss_rank.png", "png");
saveas(gcf, "./figure/polar_good_hss_rank.eps", "epsc");
...
lgd.Interpreter = 'latex';
set(gca, 'FontSize', 18);
saveas(gcf, "./figure/polar_good_memory.png", "png");
saveas(gcf, "./figure/polar_good_memory.eps", "epsc");
...
lgd.Interpreter = 'latex';
set(gca, 'FontSize', 18);
saveas(gcf, "./figure/polar_good_t_construct.png", "png");
saveas(gcf, "./figure/polar_good_t_construct.eps", "epsc");
...
lgd.Interpreter = 'latex';
set(gca, 'FontSize', 18);
saveas(gcf, "./figure/polar_good_t_factor.png", "png");
saveas(gcf, "./figure/polar_good_t_factor.eps", "epsc");
...
lgd.Interpreter = 'latex';
set(gca, 'FontSize', 18);
saveas(gcf, "./figure/polar_good_t_solve.png", "png");
saveas(gcf, "./figure/polar_good_t_solve.eps", "epsc");
...
lgd.Interpreter = 'latex';
set(gca, 'FontSize', 18);
saveas(gcf, "./figure/polar_good_rel_res.png", "png");
saveas(gcf, "./figure/polar_good_rel_res.eps", "epsc");
...
lgd.Interpreter = 'latex';
set(gca, 'FontSize', 18);
saveas(gcf, "./figure/polar_good_rel_acc.png", "png");
saveas(gcf, "./figure/polar_good_rel_acc.eps", "epsc");
